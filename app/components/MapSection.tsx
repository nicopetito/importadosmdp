...
export default function MapSection() {
  return (
    <section className="py-24 bg-gradient-to-b from-[#F8F8F6] to-white border-t border-outline-variant/10 relative overflow-hidden z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="p-3 bg-white rounded-[2.5rem] border border-outline-variant/10 shadow-[0_24px_50px_rgba(0,0,0,0.03)] hover:shadow-[0_32px_70px_rgba(0,113,227,0.08)] transition-all duration-700 hover:border-primary/20 group">
              <div className="relative h-[380px] sm:h-[440px] rounded-[2rem] overflow-hidden border border-black/[0.02]">
                ...
                {/* Visual glassmorphic card on map (optional mock info overlay) */}
          ...
          >
            <span className="text-primary font-mono text-[9px] font-bold uppercase tracking-[0.25em] mb-4 block">
              Showroom Experiencia
            </span>
            <h2 className="font-display text-[36px] sm:text-[44px] font-extrabold tracking-tight mb-4 italic text-on-surface leading-none">
            ...
            <p className="font-sans text-secondary/80 mb-8 leading-relaxed text-sm md:text-base font-light">
              Vení a experimentar los dispositivos insignia de Aura en persona. Ofrecemos asesoría exclusiva uno a uno, configuración personalizada de tus equipos de ecosistema Apple y Samsung, y un ambiente curado donde la tecnología de lujo cobra vida.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              ...
              <div className="bg-white/60 backdrop-blur-md border border-outline-variant/10 rounded-[1.5rem] p-5 flex items-start gap-4 transition-all duration-300 hover:shadow-[0_8px_20px_rgba(0,0,0,0.02)] hover:border-primary/10">
                ...
                <div>
                  <h4 className="font-display font-bold text-sm text-on-surface mb-0.5">Horarios Premium</h4>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-[#1c1c1e] text-white font-mono font-bold text-[10px] uppercase tracking-widest px-8 py-4.5 rounded-full hover:bg-primary transition-all duration-300 hover:shadow-[0_8px_25px_rgba(0,113,227,0.35)] cursor-pointer group self-start"
            >
              Obtener direcciones
