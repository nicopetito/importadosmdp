          ...
          <div className="md:col-span-4 flex flex-col items-start pr-0 md:pr-8">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                ...
                aria-label="WhatsApp"
                className="w-8 h-8 rounded-full bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-white/40 hover:text-white hover:bg-white/[0.12] transition-all duration-200"
              >
